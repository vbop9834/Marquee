...
let summary = "An open source UI Automation library using Selenium"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Marquee is an open source, Selenium based, UI Automation library written in F#."

// List of author names (for NuGet package)
let authors = [ "Jeremy Bellows" ]

// Tags for your project (for NuGet package)
let tags = "selenium UIAutomation Automation Testing Test Tools F# Functional Concurrent"

// File system information
let solutionFile  = "Marquee.sln"
