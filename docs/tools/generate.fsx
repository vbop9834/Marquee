...
let githubLink = "https://github.com/JeremyBellows/marquee/Jeremy Bellows/Marquee"

// Specify more information about your project
let info =
  [ "project-name", "Marquee"
    "project-author", "Jeremy Bellows"
    "project-summary", "An open source UI Automation library using Selenium"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Marquee" ]
